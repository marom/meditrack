...
class AppointmentControllerTest {
    ...
    void should_return200WithAppointmentBody_when_bookingSucceeds() throws Exception {
        // Arrange
        given(appointmentService.book(any(AppointmentBookRequest.class))).willReturn(sampleAppointment("REQUESTED"));
    ...
    void should_return200WithCancelledAppointment_when_cancelling() throws Exception {
        // Arrange
        given(appointmentService.cancel(7L)).willReturn(sampleAppointment("CANCELLED"));
    ...
    void should_return200WithAllAppointments_when_listing() throws Exception {
        // Arrange
        given(appointmentService.findAll()).willReturn(List.of(sampleAppointment("REQUESTED")));
    ...
    private AppointmentResponse sampleAppointment(String status) {
